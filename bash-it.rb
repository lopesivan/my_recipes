...
class BashIt < Formula
  ...
  patch do
    url 'https://raw.githubusercontent.com/lopesivan/my_patches/main/bash-it/bash-it-custom-20230808-8b0c4d2f.diff'
    sha256 'af7fb5ceb3420b8376dc8f0a31fb8cf0ff659a08dfcaae382a402f7a498fe927'
  end
